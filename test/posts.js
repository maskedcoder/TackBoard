        ...
        */
                ...
                setupNonce('/posts/new', function () {
                    agent.post('/posts/')
                        .send({
                            ...
                            url: 'this is not even remotely a url'
                        })
                        .expect(400, done);
                });
            });
                ...
                setupNonce('/posts/new', function () {
                    agent.post('/posts/')
                        .send({
                            ...
                            url: 'http://thisismysuperdupersecretnonexistantdomainthatdoesnotexistatall.com/notanapi/159/'
                        })
                        .expect(400, done);
                });
            });
        ...
        describe('Logged out actions', function () {
            ...
            it('doesn\'t find non-existant posts', function (done) {
                ...
                // from the post ID will result in an ID of a post that doesn't exist
                var nonPostLink = postLink.replace(/(\d)[\\\/]?$/, function (_, digit) {
                    return Number(digit) - 1;
                });

                agent.get(nonPostLink)
                    .expect(404, done);
            });
